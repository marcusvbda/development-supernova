<div class="flex items-center justify-between p-3 flex flex-row flex-col md:flex-row gap-3">
    ...
    <div class="w-full md:w-6/12 flex align-center justify-center">
        <div class="hidden md:block">
            <nav aria-label="Page navigation">
                <ul class="inline-flex -space-x-px text-sm">
                    ...
                    <li>
                        <a href="#"
                            class="flex items-center justify-center px-3 h-8 leading-tight text-gray-500 bg-white border border-gray-300 rounded-e-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Próxima</a>
                    </li>
                </ul>
            </nav>
        </div>
    ...
    <div class="w-full md:w-3/12 text-center md:text-right text-neutral-500 text-sm font-light dark:text-gray-300">
        Resultados 1 - 10 de 2000
    </div>
</div>
