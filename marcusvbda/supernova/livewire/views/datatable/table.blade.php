<div class="text-gray-700 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-600 dark:border-gray-700 dark:text-gray-50 overflow-x-auto mb-20"
    wire:init="init">
    @if (!$initialized)
        <div clas="flex items-center justify-center w-full">
