            ...
            <thead>
                <tr class="bg-gray-100 dark:bg-gray-600">
                    ...
                    @foreach ($columns as $key => $value)
                        ...
                        @endphp
                        <th class="@if ($field === 'id')  @endif font-normal @if ($minWidth) min-w-[{{ $minWidth }}] @endif @if ($width) w-[{{ $width }}] @endif p-5 font-medium text-gray-700 @if ($showBorder) border-right border-r border-gray-200 dark:border-gray-700 @endif dark:text-gray-200 @if ($sortable) cursor-pointer @endif"
                    ...
                    @if ($hasActions)
                        <th
                            class="w-[100px] p-5 font-medium text-gray-700 border-right border-r border-gray-200 dark:text-gray-200 dark:border-gray-700 table-column-fixed border-left border-l border-gray-200">
                            {{-- action here --}}
                        </th>
                    @endif
                </tr>
                @if ($filterable)
                    <tr class="bg-indigo-100 dark:bg-indigo-300">
                        ...
                        @if ($hasActions)
                            <th
                                class="min-w-[100px] p-5 font-medium text-gray-700 border-r border-gray-200 dark:text-gray-200 dark:border-gray-700 table-column-fixed filter">
                                {{--  --}}
                            </th>
                        @endif
                    </tr>
                    ...
                    @foreach ($itemsPage as $i => $item)
                        <tr class="{{ $i % 2 === 1 ? 'bg-gray-100 dark:bg-gray-600' : 'bg-white dark:bg-gray-500' }}">
                            @foreach ($columns as $key => $value)
                                ...
                                @endphp
                                <td
                                    class="@if ($field === 'id')  @endif p-4 px-5 text-right font-light text-sm text-gray-600 @if ($showBorder) border-r border-gray-200 dark:border-gray-700 @endif dark:text-gray-300">
                            ...
                            @if ($hasActions)
                                <td
                                    class="p-4 px-5 text-right font-light text-gray-600 dark:text-gray-300 table-column-fixed">
